 ...
 */
@Table(name = "monsys_smallidc_eu_stat_static")
public class MonsysSmallidcEuStatStatic implements Serializable {
    ...
    private Integer diskStatHis;
	    ...
	    //访问日志上报状态(1-异常，0-正常)
    @Column(name = "du_accesslog_stat")
    private Integer duAccesslogStat;
	
	    //访问日志上报是否发生异常(1-异常，0-正常)
    @Column(name = "du_accesslog_stat_his")
    private Integer duAccesslogStatHis;
	...
	/**
	 * 设置：访问日志上报状态(1-异常，0-正常)
	 */
	public void setDuAccesslogStat(Integer duAccesslogStat) {
		this.duAccesslogStat = duAccesslogStat;
	}
	/**
	 * 获取：访问日志上报状态(1-异常，0-正常)
	 */
	public Integer getDuAccesslogStat() {
		return duAccesslogStat;
	}
	/**
	 * 设置：访问日志上报是否发生异常(1-异常，0-正常)
	 */
	public void setDuAccesslogStatHis(Integer duAccesslogStatHis) {
		this.duAccesslogStatHis = duAccesslogStatHis;
	}
	/**
	 * 获取：访问日志上报是否发生异常(1-异常，0-正常)
	 */
	public Integer getDuAccesslogStatHis() {
		return duAccesslogStatHis;
	}
	/**
